      ...
      <div className="h-screen overflow-hidden p-2 sm:p-2 lg:p-4">
        <div className="max-w-5xl mx-auto h-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-start h-full">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-6 border border-gray-200 hover:shadow-2xl transition-shadow duration-300">
              <div className="text-center">
                ...
                <button
                  type="button"
                  onClick={getQrCode}
                  className="w-full py-3 px-4 bg-gradient-to-r from-green-600 to-green-700 text-white text-md font-semibold rounded-xl hover:from-green-700 hover:to-green-800 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl flex items-center justify-center"
                >
